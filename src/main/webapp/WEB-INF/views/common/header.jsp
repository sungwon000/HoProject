...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">MIUSE</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">미우세?</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#portfolio">환영합니다</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">Q/A</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#team">로그인</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">미혼모 자립 및 취업</div>
        <div class="intro-heading text-uppercase">미혼모와 우리가 만드는 세상</div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">미우세</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">미우세?</h2>
          <h3 class="section-subheading text-muted">우리는 이런일을 합니다</h3>
        </div>
      </div>
